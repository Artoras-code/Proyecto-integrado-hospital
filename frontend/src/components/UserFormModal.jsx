...
export default function UserFormModal({ isOpen, onClose, onSave, userToEdit }) {
  ...
  return (
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      ...
      <div className="w-full max-w-lg rounded-lg bg-gray-800 p-6 shadow-2xl">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full rounded-md border-gray-700 bg-gray-900 text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
              />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              <label htmlFor="first_name" className="text-sm font-medium text-gray-300">Nombre</label>
              <input
                type="text"
                name="first_name"
                id="first_name"
            ...
            <div>
              <label htmlFor="last_name" className="text-sm font-medium text-gray-300">Apellido</label>
              <input
                type="text"
                name="last_name"
                id="last_name"
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
             <div>
              <label htmlFor="rut" className="text-sm font-medium text-gray-300">RUT</label>
              <input
                type="text"
                name="rut"
                id="rut"
            ...
            <div>
              <label htmlFor="rol" className="text-sm font-medium text-gray-300">Rol</label>
              <select
                name="rol"
                id="rol"
